...
const rooms: Room[] = [
  {
    ...
    rentalPeriod: 'day', furnished: true,
    furnitureDescription: 'Salon 3 pièces, table à manger 4 chaises, lit double, armoire, réfrigérateur, cuisinière, téléviseur, climatiseur.',
  ...
  },
  {
    ...
    rentalPeriod: 'day', furnished: true,
    furnitureDescription: 'Salon complet, 2 chambres meublées (lits + armoires), cuisine équipée, machine à laver, climatiseurs.',
  ...
  },
  {
    ...
    rentalPeriod: 'day', furnished: true,
    furnitureDescription: 'Lit simple, bureau, chaise, kitchenette équipée, réfrigérateur.',
  ...
  },
  {
    ...
    rentalPeriod: 'day', furnished: false,
    propertyType: 'rental', ownerClientId: 'cli-9', ownerName: 'Djamel Ferhat',
  ...
  },
  {
    ...
    pricePerNight: 75000, status: 'maintenance',
    ...
    rentalPeriod: 'month', furnished: false,
  ...
  },
  {
    ...
    rentalPeriod: 'day', furnished: true,
    furnitureDescription: 'Salon marocain, 3 lits, armoires, réfrigérateur, cuisinière, téléviseur.',
  ...
  },
  {
    ...
    rentalPeriod: 'day', furnished: true,
    furnitureDescription: 'Cuisine intégrée, salon d’angle, chambre à coucher complète, chauffe-eau, climatiseur.',
  ...
  },
  {
    ...
    pricePerNight: 90000, status: 'available',
    commune: 'Chéraga',
  ...
  {
    id: 'apt-13', name: 'D-501', capacity: 2, floorId: 'flr-4', categoryId: 'cat-2',
    pricePerNight: 42000, status: 'available',
    commune: 'Chéraga',
    description: 'F2 meublé loué au mois, idéal cadre en mission longue durée.',
    rentalPeriod: 'month', furnished: true,
    furnitureDescription: 'Salon 3 pièces, chambre à coucher complète, cuisine équipée (réfrigérateur, cuisinière, micro-ondes), machine à laver, téléviseur, climatiseur.',
    propertyType: 'rental', ownerName: 'Nadia Cherif', ownerPhone: '0661 33 44 55',
    mediatorId: 'med-1',
  },
  {
    id: 'apt-14', name: 'D-502', capacity: 4, floorId: 'flr-3', categoryId: 'cat-4',
    pricePerNight: 68000, status: 'available',
    commune: 'Bab Ezzouar',
    description: 'F4 vide loué au mois, proche université et tramway.',
    rentalPeriod: 'month', furnished: false,
    propertyType: 'rental', ownerName: 'Kamel Boudjema', ownerPhone: '0770 11 22 33',
  },
];
...
const workers: Worker[] = [
  ...
  {
    id: 'wrk-7', name: 'Yacine Haddad', birthDate: '1990-02-11', cin: '160290211',
    phone: '0555 77 88 99', role: 'Médiateur', startDate: m(-16, 3),
    hasSalary: false,
    hasAccount: false, permissions: {},
  ...
  {
    id: 'wrk-8', name: 'Souad Meziane', birthDate: '1995-09-08', cin: '160995908',
    phone: '0661 60 60 60', role: 'Médiateur', startDate: m(-7, 18),
    hasSalary: true, salaryType: 'monthly', salaryAmount: 40000,
    hasAccount: false, permissions: {},
    advances: [], absences: [],
    payments: [{ id: 'wp-10', date: m(-1, 28), amount: 40000, description: 'Salaire mensuel' }],
    active: true,
  },
  {

...
import {
  Building2, Mail, Lock, LogIn, UserPlus, Sparkles,
...
export default function Login() {
  ...
  const loginDemo = useApp((s) => s.loginDemo);
  ...
  // Connexion en un clic avec le compte administrateur de démonstration :
  // toutes les interfaces sont alors remplies avec le jeu de données de test.
              ...
              <motion.div variants={staggerContainer} initial="initial" animate="animate">
                ...
                {mode === 'signin' ? (
                  ...
                  <motion.form onSubmit={handleLogin} className="space-y-4">
                    ...
                    {/* ── Connexion démo (données de test préchargées) ── */}
                    <motion.div variants={fadeInUp}>
                      <GradientButton
                        type="button"
                        variant="outline"
